...
export type IProduitState = IPaginationBaseState;

export class Produit extends React.Component<IProduitProps, IProduitState> {
  state: IProduitState = {
  ...
  render() {
    const { produitList, match } = this.props;
    return (
      <div>
        <h2 id="produit-heading">
          Produits
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp; Create new Produit
          </Link>
        </h2>
            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('quantite')}>
                    Quantite <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={this.sort('prix')}>
