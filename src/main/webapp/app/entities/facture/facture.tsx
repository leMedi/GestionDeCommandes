      ...
      <div>
        <h2 id="facture-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp; Create new Facture
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('montant')}>
                  Montant <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  Commande <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {factureList.map((facture, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <TextFormat type="date" value={facture.date} format={APP_DATE_FORMAT} />
                  </td>
                  <td>{facture.montant}</td>
                  <td>{facture.commande ? <Link to={`commande/${facture.commande.id}`}>{facture.commande.id}</Link> : ''}</td>
