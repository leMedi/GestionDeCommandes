    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="gestionDeCommandesApp.client.home.createOrEditLabel">Create or edit a Client</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : clientEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="client-prenom" type="text" name="prenom" />
                </AvGroup>
                <AvGroup>
                  <Label id="adresseLabel" for="adresse">
                    Adresse
                  </Label>
                ...
                <AvGroup>
                  ...
                  <AvField id="client-telephone" type="string" className="form-control" name="telephone" />
                </AvGroup>
